...
<div class="wrapper">
    <header class="slidebar">
        <a href="/" class="logo-link">
            <img src="data/img/BITFILIX_logo.svg" alt="logo">
        </a>
        <nav class="menu">
            <ul>
    ...
    <header class="toolbar">
        <div class="search-line">
            <img src="data/img/search%201.png" style="width: 24px;height: 24px;padding-right: 10px">
            ...
            <div class="detail-item">
                <div class="detail-item-header">
                    <div class="detail-item-header-main-name">
                        ...
                        <img src="data/img/add_to_pref_2.png">
                    </div>
                    <div class="detail-item-header-second-name">
                        <p class="sure-name-font">Inside Out</p>
                        <div class="grey-border-square"><p class="font-for-search-line">6+</p></div>
                    </div>
                </div>
                <div class="detail-item-filling">
                    <img src="data/img/inside_out_poster.png" class="detail-item-image">
